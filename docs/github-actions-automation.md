...
```bash
python scripts/deploy_bedrock_geyser.py
```

Заливает моды и `config/Geyser-Fabric/config.yml`. После — **рестарт** сервера в Play2GO. Инструкция: [bedrock-geyser-play2go-ru.md](bedrock-geyser-play2go-ru.md).
