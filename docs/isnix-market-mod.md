...
2. **Изумруд «Выставить предмет»** или **`/sell list`**:
   - **книги «Каталог товара» / «Каталог цены»** — шаблон предмета;
   - **товар списывается только из инвентаря игрока** (не из слотов меню);
   - **Shift+клик** из нижнего инвентаря — быстро выбрать товар/цену;
